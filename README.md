...
## Ресурсы, где ты обязан быть каждый день
  ...
  * [Stackoveflow](https://stackoverflow.com/) - то же, чте предыдущий, только больше, круче, подробнее и на английском. Здесь можно найти ответ ну практически на все.
  ...
  * [Codelabs](https://codelabs.developers.google.com/) - очень полезный ресурс от Гуглов. Содержит массу тутуриалов о том, как делать крутые штуки (если вам в особенности прилянутся какие-то фичи - давайте разберем что-нибудь на занятии).
  
  
## Дополнительный материал (на данный момент редактируется)
